...
const AdminTickets = () => {
  ...
  const KEVIN = { email: "kcastillo@memphis.pe", nombre: "Kevin Castillo" };
  ...
  const tomarTicketKevin = async () => {
    if (!seleccionado) return;
    await asignarTicket(seleccionado.id, KEVIN);
    await cargar();
  };
      ...
      <div className="lg:col-span-1 space-y-4">
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="flex gap-2 mb-3">
            ...
            <select className="border rounded px-2 py-1 text-sm" value={filtro.prioridad} onChange={e => setFiltro(f => ({ ...f, prioridad: e.target.value }))}>
      ...
      <div className="lg:col-span-2">
        {!seleccionado ? (
          ...
          <div className="bg-white p-6 rounded shadow space-y-4">
            ...
            <div className="text-sm">
              Asignado a: {seleccionado.asignadoA ? (seleccionado.asignadoA.nombre || seleccionado.asignadoA.email) : "—"}
            </div>
