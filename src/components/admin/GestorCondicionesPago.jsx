...
const GestorCondicionesPago = ({ condiciones = [], agregar, cambiarEstado }) => {
  const [nuevo, setNuevo] = useState("");
  const [pagina, setPagina] = useState(1);
  const porPagina = 5;

  const totalPaginas = Math.ceil(condiciones.length / porPagina) || 1;
  const visibles = condiciones
