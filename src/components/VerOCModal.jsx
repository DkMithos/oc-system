      ...
      <div id="modal-oc-print" className="p-3" style={{ fontFamily: "Arial, sans-serif", fontSize: 11, lineHeight: 1.25 }}>
        ...
        <div className="mt-2 text-[9px] leading-snug text-gray-700 border-t pt-1">
          ...
          <ul className="list-disc pl-4">
            <li>FACTURAS ELECTRÓNICAS: dmendez@memphis.pe | facturacion@memphis.pe | compras@memphis.pe | mcastaneda@memphis.pe</li>
            <li>CONSULTA DE PAGOS: sbujaico@memphis.pe | dmendez@memphis.pe</li>
          </ul>
