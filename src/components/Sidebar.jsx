...
import {
  ...
  Boxes, ClipboardCheck, Edit3, Upload, CalendarDays
} from "lucide-react";
...
const MENU = [
  ...
  },
  {
    ...
    items: [
      ...
      { ruta: "/dashboard-gerencial",texto: "Dashboard Gerencial", icon: Activity },
      { ruta: "/presupuesto-vs-ejecutado",texto: "Presupuesto vs Ejecutado", icon: TrendingUp },
      { ruta: "/mesa-pagos",            texto: "Mesa de Pagos",              icon: DollarSign },
      { ruta: "/compromisos",           texto: "Compromisos",                icon: ClipboardCheck },
      { ruta: "/instrumentos-financieros", texto: "Instrumentos (CIPRL)",     icon: FileText },
      { ruta: "/planificacion",     texto: "Planificación Pagos",  icon: CalendarDays },
        ...
        <div className="px-4 py-3 border-b border-white/10 flex-shrink-0">
          <div className="flex items-center gap-2">
            ...
            <div className="min-w-0">
              ...
              <span className="inline-block mt-1 text-[10px] bg-[#f0c000]/20 text-amber-300 border border-amber-400/30 px-1.5 py-0.5 rounded-full uppercase tracking-wider font-semibold">
                {ROL_LABELS[rol] || rol}
              </span>
            </div>
          </div>
              ...
              <div key={grupo.id}>
                ...
                >
                  <span className="flex items-center gap-2.5">
                    ...
                    {grupoActivo && (
                      <span className="w-1.5 h-1.5 rounded-full bg-[#f0c000] flex-shrink-0" />
                    )}
                  </span>
                  <ChevronDown
                    size={13}
